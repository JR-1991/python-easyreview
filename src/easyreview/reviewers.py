...
class Reviewers:
    ...
    def get_reviewer(self, request: components.ReviewerInput) -> operations.GetReviewerResponse:
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = base_url + '/api/reviewers/add/'
        headers = {}
        ...
        res = operations.GetReviewerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
