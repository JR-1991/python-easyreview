...
class FieldInput:
    ...
    accepted: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accepted'), 'exclude': lambda f: f is FieldInput.UNSET }, 'form': { 'field_name': 'accepted' }, 'multipart_form': { 'field_name': 'accepted' }})
    ...
    metadatablock: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadatablock'), 'exclude': lambda f: f is FieldInput.UNSET }, 'form': { 'field_name': 'metadatablock' }, 'multipart_form': { 'field_name': 'metadatablock' }})
    compound: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compound'), 'exclude': lambda f: f is FieldInput.UNSET }, 'form': { 'field_name': 'compound' }, 'multipart_form': { 'field_name': 'compound' }})
